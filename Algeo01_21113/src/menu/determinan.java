...
public class determinan extends JFrame implements ActionListener{
		private JLabel welcomeDeterminan;
		JMenuBar menuBar;
		...
		public determinan() {
			...
			welcomeDeterminan = new JLabel("Hello, Welcome to Determinant Section!\n");
			this.add(welcomeDeterminan);
